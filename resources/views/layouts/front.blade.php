			...
			<div class="col-sm-8">
				...
				<div class="masonrygrid row listrecent">
					...
					<div class="col-md-6 grid-item">
						<div class="card">
							<a href="single.html">
							<img class="img-fluid" src="{{asset('assetsFront')}}/images/2.jpg" alt="Tree of Codes">
							</a>
							<div class="card-block">
					...
					<div class="col-md-6 grid-item">
						<div class="card">
							<a href="single.html">
							<img class="img-fluid" src="{{asset('assetsFront')}}/images/6.jpg" alt="Markdown Example">
							</a>
							<div class="card-block">
		...
		<div class="row">
			<div class="col-sm-3">
				<div class="footer-widget">
					<a href="contact.html">
					<img src="{{asset('assetsFront')}}/images/logo-footer.png" alt="logo footer">
					</a>
				</div>
			</div>
			<div class="col-sm-3">
